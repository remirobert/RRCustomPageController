...
#define COCOAPODS_POD_AVAILABLE_RRCustomPageController
#define COCOAPODS_VERSION_MAJOR_RRCustomPageController 0
#define COCOAPODS_VERSION_MINOR_RRCustomPageController 1
#define COCOAPODS_VERSION_PATCH_RRCustomPageController 0
